...
.spell-0.up.active, .spell-0.up:hover { border-color: var(--t) var(--t) #FECE91 var(--t); color: #111; }
.spell-1.up.active, .spell-1.up:hover { border-color: var(--t) var(--t) #FE9F6D var(--t); color: #111; }
.spell-2.up.active, .spell-2.up:hover { border-color: var(--t) var(--t) #F76F5C var(--t); color: #222; }
.spell-3.up.active, .spell-3.up:hover { border-color: var(--t) var(--t) #DE4968 var(--t); color: #222; }
.spell-4.up.active, .spell-4.up:hover { border-color: var(--t) var(--t) #B63679 var(--t); color: #333; }
.spell-5.up.active, .spell-5.up:hover { border-color: var(--t) var(--t) #8C2981 var(--t); color: #eee; }
.spell-6.up.active, .spell-6.up:hover { border-color: var(--t) var(--t) #641A80 var(--t); color: #eee; }
...
.spell-2.down.active, .spell-2.down:hover { border-color: #F76F5C var(--t) var(--t) var(--t); color: #222; }
.spell-3.down.active, .spell-3.down:hover { border-color: #DE4968 var(--t) var(--t) var(--t); color: #222; }
.spell-4.down.active, .spell-4.down:hover { border-color: #B63679 var(--t) var(--t) var(--t); color: #333; }
.spell-5.down.active, .spell-5.down:hover { border-color: #8C2981 var(--t) var(--t) var(--t); color: #eee; }
.spell-6.down.active, .spell-6.down:hover { border-color: #641A80 var(--t) var(--t) var(--t); color: #eee; }
